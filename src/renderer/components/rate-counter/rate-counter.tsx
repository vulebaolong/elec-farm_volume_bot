                        ...
                        <TooltipContent className="max-w-[420px] text-xs leading-relaxed">
                            <div className="space-y-2">
                                ...
                                <ul className="list-disc pl-4 space-y-1">
                                    <li>
                                        Số <b>bên trái</b> cho biết <b>đã gửi bao nhiêu lệnh</b> trong khoảng thời gian đó (tính đến thời điểm hiện
                                        tại).
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Các lệnh <b>quá cũ</b> sẽ tự động <b>không còn được tính</b> sau khi hết khoảng thời gian tương ứng, nên con
                                        số có thể <b>giảm xuống dần theo thời gian</b>.
                                    </li>
                                </ul>
