        ...
        <div className={cn("flex flex-col gap-6 max-w-sm", className)} {...props}>
            ...
            <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-center text-sm">
                    ...
                    <Button className="text-sm font-light p-0" onClick={() => navigate(ROUTER.LOGIN)} variant="link">
                        Log in
                    </Button>
                </div>
            </div>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    <div className="grid gap-2">
                        ...
                        />
                        <ButtonLoading loading={registerForm.isPending} type="submit" className="w-full">
                            Create Account
                        </ButtonLoading>
                    </div>
                </form>
