                        ...
                        {symbols.map((item) => {
                            ...
                            return (
                                <AccordionItem
                                    key={item.symbol}
                                    value={item.symbol}
                                    className={isQualified ? "border border-green-500 shadow-md rounded-md" : ""}
                                >
                                        ...
                                        <div className="flex items-center gap-1 text-xs font-medium">
                                            ...
                                            <div className="flex gap-1">
                                                <Badge
                                                    ...
                                                    className={item.flags?.isLong ? "bg-green-500 text-white" : ""}
                                                >
                                                    Long
                                                </Badge>
                                                <Badge
                                                    variant={item.flags?.isShort ? "default" : "outline"}
                                                    className={item.flags?.isShort ? "bg-red-500 text-white" : ""}
                                                >
                                                    Short
                                                </Badge>
                                                ...
                                                <Badge variant={checkSize(item.size) ? "default" : "outline"}>Size</Badge>
                                            </div>
                                        </div>
                                    </AccordionTrigger>
                                    <AccordionContent className="bg-background px-4 py-2 text-sm space-y-1 rounded-md">
                                        ...
                                        <div className="flex items-center gap-2 text-sm">
                                            ...
                                            <Badge variant={checkSize(item.size) ? "default" : "outline"}>{item.size}</Badge>
                                        </div>
                                        <div className="flex items-center gap-2 text-sm">
